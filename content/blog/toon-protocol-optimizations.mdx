...
category: "research"
excerpt: "Discover how TOON Protocol targets a 38.4% token footprint reduction (internal benchmark) while the FDIA equation gates system intents to maintain alignment and reduce costs."
...
Together, these mechanisms target token overhead compression of **38.4%** while keeping hallucination rates below a **0.3% target** — figures from internal benchmarks, not yet independently audited.

> **Note:** the specific percentages in this article are self-reported internal benchmarks. See [how-to-reduce-ai-hallucination](/blog/how-to-reduce-ai-hallucination) for a more fully-hedged treatment of the hallucination-rate claim, and TESTING_CANONICAL.md in the delentia-mcp-ecosystem repo for what is independently verifiable today.
...
In internal benchmark tests across 10,000 corporate documents, the TOON Protocol reported an average of **38.4% token reduction** with no measured loss in semantic accuracy or execution quality — not yet independently audited.
